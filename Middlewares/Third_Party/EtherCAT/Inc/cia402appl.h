...
#ifdef _CiA402_
= {MAX_AXES,{DEVICE_PROFILE_TYPE,DEVICE_PROFILE_TYPE}}
#endif
;
...
#ifdef _CiA402_
= {MAX_AXES,{CSV_CSP_MODULE_ID,CSV_CSP_MODULE_ID}}
#endif
;
...
= {
/*ECATCHANGE_START(V5.11) CiA402 1*/
{5, {0x60400010,0x607A0020,0x60FF0020,0x60600008,0x00000008}},    /* TOBJ1600,controlword,target position,target velocity,modes of operation*/
/*ECATCHANGE_END(V5.11) CiA402 1*/
{2, {0x60400010,0x607A0020}}, /*TOBJ1601*/
{2, {0x60400010,0x60FF0020}}, /*TOBJ1602*/
/*ECATCHANGE_START(V5.11) CiA402 1*/
{5, {0x60410010,0x60640020,0x606C0020,0x60610008,0x00000008}}, /*TOBJ1A00,statusword,position actual value,velocity actual value,modes of operation display*/
/*ECATCHANGE_END(V5.11) CiA402 1*/
