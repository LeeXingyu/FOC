...
#define ECAT_NOTIFY_PDI    (1u << 0)
#define ECAT_NOTIFY_SYNC0  (1u << 1)
#define ECAT_NOTIFY_SYNC1  (1u << 2)
#define ECAT_NOTIFY_TIMER  (1u << 3)
...
#ifndef HW_GetTimer
#define HW_GetTimer()       	TIM4->CNT		/**< \brief Access to the hardware timer*/
#endif

#ifndef HW_ClearTimer
#define HW_ClearTimer()         ((TIM4->CNT)=0);  /**< \brief Clear the hardware timer*/
#endif
...
PROTO uint8_t ECAT_HandleExtiInterrupt(uint16_t GPIO_Pin);
