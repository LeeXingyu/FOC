...
void EXTI0_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(COMM_IO2_Pin);
...
void TIM4_IRQHandler(void)
{
  ...
  extern void ECAT_TIM_CallBack(void); /* EtherCAT 1ms tick */
  ECAT_TIM_CallBack();
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(COMM_INT_Pin);
  HAL_GPIO_EXTI_IRQHandler(COMM_IO1_Pin);
