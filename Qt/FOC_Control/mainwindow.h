...
private:
    ...
    void setupCia402Page(QWidget *page);
    ...
    void handleParamLine(const QString &line);
    ...
    QPushButton *m_startRsTuneButton = nullptr;
    QPushButton *m_startFullTuneButton = nullptr;
    QPushButton *m_stopCalibButton = nullptr;
    QPushButton *m_readFlashButton = nullptr;
    QPushButton *m_clearFlashButton = nullptr;
    QPushButton *m_cia402SendCwButton = nullptr;
    QPushButton *m_cia402SendModeButton = nullptr;
    QPushButton *m_cia402SendSpeedButton = nullptr;
    QPushButton *m_cia402SendTorqueButton = nullptr;
    QPushButton *m_cia402QueryButton = nullptr;
    QPushButton *m_paramQueryButton = nullptr;
    ...
    QSpinBox *m_cia402ControlWordSpin = nullptr;
    QComboBox *m_cia402ModeCombo = nullptr;
    QDoubleSpinBox *m_cia402SpeedRefSpin = nullptr;
    QDoubleSpinBox *m_cia402TorqueRefSpin = nullptr;
    ...
    QLineSeries *m_speedRefSeries = nullptr;
    ...
    QVector<QPointF> m_speedRefPoints;
    QVector<QPointF> m_speedIqPoints;
    QVector<QPointF> m_speedIdPoints;
    qint64 m_speedSampleIndex = 0;
    int m_speedWindowSize = 600;
    bool m_angleAutoFollow = true;
    bool m_speedAutoFollow = true;
    double m_lastSpeedRpm = 0.0;
    double m_lastSpeedRefRpm = 0.0;
    double m_lastIqAmp = 0.0;
    double m_lastIdAmp = 0.0;
    unsigned int m_lastCia402Statusword = 0U;
    unsigned int m_lastCia402Mode = 0U;
    unsigned int m_lastAxisState = 0U;
    unsigned int m_lastAxisError = 0U;
    unsigned int m_lastControlMode = 0U;
    unsigned int m_lastParamState = 0U;
    unsigned int m_lastTelemetrySequence = 0U;
    unsigned int m_lastTelemetryDeviceTick = 0U;
    qint64 m_lastAngleUiTick = 0;
    qint64 m_lastSpeedUiTick = 0;
    qint64 m_lastChartRefreshTick = 0;

    QLabel *m_statusLink = nullptr;
    QLabel *m_cia402StatusWordLabel = nullptr;
    QLabel *m_cia402ModeLabel = nullptr;
    QLabel *m_cia402AxisStateLabel = nullptr;
    QLabel *m_cia402ErrorLabel = nullptr;
    QLabel *m_cia402ControlModeLabel = nullptr;
    QLabel *m_cia402ParamStateLabel = nullptr;
    QLabel *m_cia402SpeedRefLabel = nullptr;
    QLabel *m_cia402TorqueRefLabel = nullptr;
    QLabel *m_paramValidLabel = nullptr;
    QLabel *m_paramRsLabel = nullptr;
    QLabel *m_paramLdLabel = nullptr;
    QLabel *m_paramLqLabel = nullptr;
    QLabel *m_paramKeLabel = nullptr;
    QVector<QPointF> m_angleMechPoints;
    QVector<QPointF> m_angleAppPoints;
    qint64 m_sampleIndex = 0;
    qint64 m_plotTimeBaseMs = 0;
